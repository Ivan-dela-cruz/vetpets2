...
var GLM = {DOM: Object, AJAX: Object, Collection: Object};
            ...
            ao.onreadystatechange = function () {
                if (ao.readyState == 4) {
                    try {
                        ...
                        if (response.textContent) callbackFunction(response.textContent); else if (response.text) callbackFunction(response.text);
                    } catch (ex) {
                        callServiceError(ex);
                    }
                }
