...
@section('niveles')
    ...
    <li class="breadcrumb-item"><a class="text-dark" href="#">Veterinario</a></li>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table id="table" class="table m-0 table-bordered table-responsive">
                                    ...
                                    {{ csrf_field() }}
                                    <?php  $no = 1; ?>
                                    @foreach( $veterinarys as $veterinary )
                                        <tr class="cat{{$vet->id}}">

                                            <td>{{$veterinary->id}}</td>
                                            <td>{{$veterinary->name_veteri}}</td>
                                            <td>{{$veterinary->lenght_veteri}}</td>
                                            <td>{{$veterinary->latitude_vetery}}</td>
                                            <td>{{$veterinary->province_vetery}}</td>
                                            <td>{{$veterinary->canton_vetery}}</td>
                                            <td>{{$veterinary->address_vetery}}</td>
                                            <td>{{$veterinary->urlphoto_vetery}}</td>
                                            <td>{{$veterinary->schedule_vetery}}</td>
                                            <td>{{$veterinary->description_vetery}}</td>
                                            <td>{{$veterinary->created_at}}</td>
                                            <td>{{$veterinary->updated_at}}</td>
                                            <td width="10px">
                                                <a href="#" class="show-modal-cat btn btn-info btn-sm"
                                                   data-id-cat="{{$veterinary->id}}" data-name-cat="{{$veterinary->name}}"
                                                   data-body-cat="{{$veterinary->description}}">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                            <td width="10px">
                                                <a href="#" class="edit-modal-cat btn btn-warning btn-sm"
                                                   data-id-cat="{{$veterinary->id}}"
                                                   data-name-cat="{{$veterinary->name}}" data-body-cat="{{$veterinary->description}}">
