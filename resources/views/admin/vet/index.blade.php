                                ...
                                <table id="table" class="table m-0 table-bordered table-responsive">
                                    ...
                                    @foreach( $vets as $vet )
                                        <tr class="cat{{$vet->id}}">
                                            ...
                                            <td>{{$vet->id}}</td>
                                            <td>{{$vet->speciality_vet}}</td>
                                            <td>{{$vet->votes_vet}}</td>
                                            <td>{{$vet->ranking_vet}}</td>
                                            <td>{{$vet->created_at}}</td>
                                            <td>{{$vet->updated_at}}</td>
                                            <td width="10px">
                                                <a href="#" class="show-modal-cat btn btn-info btn-sm"
                                                   data-id-cat="{{$vet->id}}" data-name-cat="{{$vet->name}}"
                                                   data-body-cat="{{$vet->description}}">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                            <td width="10px">
                                                <a href="#" class="edit-modal-cat btn btn-warning btn-sm"
                                                   data-id-cat="{{$vet->id}}"
                                                   data-name-cat="{{$vet->name}}" data-body-cat="{{$vet->description}}">
