...
@section('niveles')
    ...
    <li class="breadcrumb-item"><a class="text-dark" href="#">Animales</a></li>
                                ...
                                <table id="table" class="table m-0 table-bordered table-responsive">
                                    ...
                                    @foreach( $animals as $animal )
                                        <tr class="cat{{$animal->id}}">
                                            ...
                                            <td>{{$animal->weight}}</td>
                                            <td>{{$animal->sex}}</td>
                                            <td>{{$animal->urlphoto}}</td>
                                            <td>{{$animal->created_at}}</td>
                                            <td>{{$animal->updated_at}}</td>
                                            <td width="10px">
                                                <a href="#" class="show-modal-cat btn btn-info btn-sm"
                                                   data-id-cat="{{$animal->id}}" data-name-cat="{{$animal->name}}"
                                                   data-body-cat="{{$animal->description}}">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                            <td width="10px">
                                                <a href="#" class="edit-modal-cat btn btn-warning btn-sm"
                                                   data-id-cat="{{$animal->id}}"
                                                   data-name-cat="{{$animal->name}}" data-body-cat="{{$animal->description}}">
