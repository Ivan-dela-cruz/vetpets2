...
@endsection
@section('scripts')
    <script src="{{asset('admin/plugins/ajax/appointment.js')}}" type="text/javascript"></script>
@endsection
@section('noti')
    active
@endsection
...
@section('niveles')
    ...
    <li class="breadcrumb-item"><a class="text-dark" href="#">Citas</a></li>
                            ...
                            <div class="table-responsive">
                                <table id="table" class="table m-0 table-bordered table-responsive">
                                    ...
                                    @foreach( $appointments as $appointment)
                                        <tr class="cat{{$appointment->id}}">

                                            <td>{{$appointment->id}}</td>
                                            <td>{{$appointment->id_veterinary}}</td>
                                            <td>{{$appointment->id_client}}</td>
                                            ...
                                            <td width="10px">
                                                <a href="#" class="show-modal-cat btn btn-info btn-sm"
                                                   data-id-cat="{{$appointment->id}}" data-name-cat="{{$appointment->name}}"
                                                   data-body-cat="{{$appointment->description}}">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                            <td width="10px">
                                                <a href="#" class="edit-modal-cat btn btn-warning btn-sm"
                                                   data-id-cat="{{$appointment->id}}"
                                                   data-name-cat="{{$appointment->name}}" data-body-cat="{{$appointment->description}}">
