...
@section('niveles')
    ...
    <li class="breadcrumb-item"><a class="text-dark" href="#">Enfermedad</a></li>
                                        ...
                                        <tr class="cat{{$disease->id}}">
                                            ...
                                            <td width="10px">
                                                <a href="#" class="show-modal-cat btn btn-info btn-sm"
                                                   data-id-cat="{{$disease->id}}" data-name-cat="{{$diseasel->name}}"
                                                   data-body-cat="{{$disease->description}}">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                            <td width="10px">
                                                <a href="#" class="edit-modal-cat btn btn-warning btn-sm"
                                                   data-id-cat="{{$disease->id}}"
                                                   data-name-cat="{{$disease->name}}" data-body-cat="{{$disease->description}}">
