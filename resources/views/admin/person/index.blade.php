                                        ...
                                        <tr class="cat{{$person->id}}">
                                            ...
                                            <td width="10px">
                                                <a href="#" class="show-modal-cat btn btn-info btn-sm"
                                                   data-id-cat="{{$person->id}}" data-name-cat="{{$person->name_people}}"
                                            ...
                                            <td width="10px">
                                                <a href="#" class="edit-modal-cat btn btn-warning btn-sm"
                                                   ...
                                                   data-name-cat="{{$person->name_people}}" data-body-cat="{{$person->ci_people}}">
                                            ...
                                            <td width="10px">
                                                <a href="#" class="delete-modal-cat btn btn-danger btn-sm"
                                                   data-id-cat="{{$person->id}}"
                                                   data-name-cat="{{$person->name_people}}" data-body-cat="{{$person->_people}}">
