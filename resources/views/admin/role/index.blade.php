...
@section('niveles')
    ...
    <li class="breadcrumb-item"><a class="text-dark" href="#">Roles</a></li>
                            ...
                            <div class="table-responsive">
                                <table id="table" class="table m-0 table-bordered table-responsive">
                                    ...
                                    @foreach( $roles as $role )
                                        <tr class="cat{{$role->id}}">

                                            <td>{{$role->id}}</td>
                                            <td>{{$role->name_rol}}</td>
                                            <td>{{$role->description_rol}}</td>
                                            <td>{{$role->condition_rol}}</td>
                                            <td>{{$role->created_at}}</td>
                                            <td>{{$role->updated_at}}</td>
                                            <td width="10px">
                                                <a href="#" class="show-modal-cat btn btn-info btn-sm"
                                                   data-id-cat="{{$role->id}}" data-name-cat="{{$role->name}}"
                                                   data-body-cat="{{$role->description}}">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                            <td width="10px">
                                                <a href="#" class="edit-modal-cat btn btn-warning btn-sm"
                                                   data-id-cat="{{$role->id}}"
                                                   data-name-cat="{{$role->name_rol}}" data-body-cat="{{$role->condition_rol}}">
