...
@section('niveles')
    ...
    <li class="breadcrumb-item"><a class="text-dark" href="#">Reportes</a></li>
                                        ...
                                        <tr class="cat{{$appointment->id}}">
                                            ...
                                            <td width="10px">
                                                <a href="#" class="show-modal-cat btn btn-info btn-sm"
                                                   data-id-cat="{{$report->id}}" data-name-cat="{{$report->name}}"
                                                   data-body-cat="{{$report->description}}">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                            <td width="10px">
                                                <a href="#" class="edit-modal-cat btn btn-warning btn-sm"
                                                   data-id-cat="{{$report->id}}"
                                                   data-name-cat="{{$report->name}}" data-body-cat="{{$report->description}}">
