...
@section('niveles')
    ...
    <li class="breadcrumb-item"><a class="text-dark" href="#">Servicio</a></li>
                                ...
                                <table id="table" class="table m-0 table-bordered table-responsive">
                                    ...
                                    @foreach( $services as $service)
                                        <tr class="cat{{$animal->id}}">
                                            ...
                                            <td>{{$service->id}}</td>
                                            <td>{{$service->id_cat}}</td>
                                            <td>{{$service->name_ser}}</td>
                                            <td>{{$service->description_ser}}</td>
                                            <td>{{$service->price}}</td>
                                            <td>{{$service->urlphoto}}</td>
                                            <td>{{$service->status}}</td>
                                            <td>{{$service->created_at}}</td>
                                            <td>{{$service->updated_at}}</td>
                                            <td width="10px">
                                                <a href="#" class="show-modal-cat btn btn-info btn-sm"
                                                   data-id-cat="{{$service->id}}" data-name-cat="{{$service->name}}"
                                                   data-body-cat="{{$service->description}}">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                            <td width="10px">
                                                <a href="#" class="edit-modal-cat btn btn-warning btn-sm"
                                                   ...
                                                   data-name-cat="{{$service->name}}" data-body-cat="{{$service->description}}">
